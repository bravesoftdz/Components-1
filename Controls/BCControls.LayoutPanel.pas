unit BCControls.LayoutPanel;

interface

uses
  System.Classes, System.Types, Vcl.Controls, Vcl.ExtCtrls, Vcl.Graphics, BCControls.LayoutController;
...
procedure Register;
begin
  RegisterComponents('bonecode', [TBCLayoutPanel]);
end;
