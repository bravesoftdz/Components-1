...
type
  TSynUniFormatNativeXml18 = class(TSynUniFormatNativeXml)
    ...
    class function ImportAttributes(Attributes: TSynAttributes; AString: string): Boolean; reintroduce; overload;
    class function ExportAttributes(Attributes: TSynAttributes; var AString: string): Boolean; reintroduce; overload;
