...
//---"Standard" (ANSI SQL keywords (Version 1, 2 and 3) (www.sql.org)-----------
  StandardKW: UnicodeString =
    ...
    'month,names,national,natural,nchar,new,new_table,next,no,none,nonunique,not,null,' +
...
//---Oracle---------------------------------------------------------------------
  ...
  OracleKW: UnicodeString =
    ...
    'BLOCK,BLOCKSIZE,BUFFER_POOL,BUFFER_POOL_KEEP,BUFFER_POOL_RECYCLE,BUILD,BY,' +
    ...
    'NOLOGGING,NOMAXVALUE,NOMINIMIZE,NOMINVALUE,NOMONITORING,NONE,NONUNIQUE,' +
    'NOORDER,NOPARALLEL,NORELY,NORESETLOGS,NOREVERSE,NORMAL,NOROWDEPENDENCIES,NOSORT,' +
